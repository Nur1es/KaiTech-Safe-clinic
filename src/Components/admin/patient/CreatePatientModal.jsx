...
import { patientTime, patsientt } from "../../../utils/constanta";
import { useForm } from "react-hook-form";
import InputDate from "../../UI/InputDate";
import TextAreaInput from "../../UI/TextAreaInput";
import { useState } from "react";
import { useDispatch, useSelector } from "react-redux";
import { getPatient, postPatient } from "../../../store/patient/patient-thunk";

export const CreatePatientModal = ({ onClose, open }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (dispatch(postPatient(patientData))) {
        dispatch(getPatient());
      }
